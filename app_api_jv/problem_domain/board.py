from app_api_jv.problem_domain import position
from app_api_jv.problem_domain import automaticPlayer
from app_api_jv.problem_domain import humanPlayer
from app_api_jv.problem_domain import boardImage
...
class Board:
	def __init__(self):
		...
		self.player1.initialize("Jogador", 1)
	...
	def getState(self):
		...
		if (self.getStatus() == 1): 
			state.setMessage("Clique em qualquer casa para iniciar")
