from app_api_jv.problem_domain import position, move, player, strategy, strategy1, strategy2, strategy3
from app_api_jv.problem_domain import boardImage, automaticPlayer, humanPlayer, board
